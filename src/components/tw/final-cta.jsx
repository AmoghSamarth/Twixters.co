...
function FacebookIcon({ className = "size-[18px]" }) {
  return (
...
function LinkedInIcon({ className = "size-[17px]" }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
...
export function FinalCta() {
  return (
    <section
      ...
      className="relative z-20 w-full p-1 sm:p-1.5 md:p-2"
    >
      <div
        className="group relative flex min-h-[calc(100vh-0.5rem)] sm:min-h-[calc(100vh-0.75rem)] md:min-h-[calc(100vh-1rem)] w-full flex-col justify-between overflow-hidden rounded-[20px] sm:rounded-[30px] md:rounded-[38px] border border-white/[0.08] bg-[#070709] transition-all duration-300 ease-out"
      >
        ...
        {/* Center Main Content (Image 4 scaled 10% bigger) */}
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 pt-24 pb-12 text-center sm:pt-32 sm:pb-16">
          ...
          <div className="flex items-center justify-center gap-5 sm:gap-7">
            <span
              aria-hidden="true"
              className="h-px w-[75px] sm:w-[132px] bg-gradient-to-r from-transparent to-white/30"
            />
            <TwixtersWatermark className="h-[33px] sm:h-[38px] w-auto text-white select-none" />
            <span
              aria-hidden="true"
              className="h-px w-[75px] sm:w-[132px] bg-gradient-to-l from-transparent to-white/30"
            />
          </div>
          ...
          {/* Double-pill CTA button (Image 3: borders 10% bigger & brighter) */}
          <div className="mt-8 sm:mt-10">
            <a
              href={finalCta.cta.href}
              target="_blank"
              rel="noreferrer"
              className="group/btn inline-flex items-center justify-center rounded-full border-[1.5px] border-white/35 bg-[#17171a] p-2 transition-all duration-300 hover:border-white/60"
            >
              <span className="flex items-center gap-3 rounded-full bg-black px-7 sm:px-8 py-3 text-[15.5px] sm:text-[16px] font-medium tracking-tight text-white transition-transform duration-300 group-hover/btn:scale-[1.01]">
                {finalCta.cta.label}
                <ArrowRight className="size-[17px] transition-transform duration-300 group-hover/btn:translate-x-1" />
              </span>
            </a>
          </div>
        </div>
        ...
        <footer className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 w-full px-6 sm:px-12 pb-7 sm:pb-9">
          ...
          {/* Image 2: Social circles 10% bigger */}
          <ul className="flex items-center gap-3.5 sm:gap-4">
            <li>
              <a
                ...
                rel="noreferrer"
                aria-label="Behance"
                className="flex size-11 sm:size-12 items-center justify-center rounded-full border border-white/15 bg-[#141416] text-white/70 transition-all duration-300 hover:border-white/40 hover:bg-white/10 hover:text-white"
              >
                <BehanceIcon />
              </a>
            </li>
            <li>
              <a
                href={site.socials?.facebook || "https://www.facebook.com/profile.php?id=100006101853561"}
                target="_blank"
                rel="noreferrer"
                aria-label="Facebook"
                className="flex size-11 sm:size-12 items-center justify-center rounded-full border border-white/15 bg-[#141416] text-white/70 transition-all duration-300 hover:border-white/40 hover:bg-white/10 hover:text-white"
            ...
            <li>
              <a
                href={site.socials?.linkedin || "https://www.linkedin.com/in/raj-shegaonkar-875999164/"}
                target="_blank"
                rel="noreferrer"
                aria-label="LinkedIn"
                className="flex size-11 sm:size-12 items-center justify-center rounded-full border border-white/15 bg-[#141416] text-white/70 transition-all duration-300 hover:border-white/40 hover:bg-white/10 hover:text-white"
            ...
            <li>
              <a
                href={site.socials?.instagram || "https://www.instagram.com/raj_shegaonkar/"}
                target="_blank"
                rel="noreferrer"
