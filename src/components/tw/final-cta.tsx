...
/**
 * The page's one tonal inversion: a dark rounded card INSET from the page edges
 * (the grey field still frames it on all four sides), with the footer inside it.
 */
export function FinalCta() {
  return (
    <section id="contact" aria-labelledby="contact-heading" className="px-4 pb-6 sm:px-8 sm:pb-8">
