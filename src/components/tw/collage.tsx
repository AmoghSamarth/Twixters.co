...
/**
 * Portfolio collage: an asymmetric mosaic inside a dark rounded shell.
 * Explicit grid areas (not a uniform grid) so proportions stay art-directed;
 * two large blocks lead, supporting blocks fill beneath.
 */
