...
/** Decorative double-prime quote mark from the reference. */
function QuoteMark() {
  return (
    <span
      aria-hidden="true"
...
/**
 * Two testimonials placed at diagonally opposite corners — free composition,
 * not an equal card row and not a carousel.
 */
export function Testimonials() {
  return (
    <section aria-label="Client feedback" className="px-5 py-8 sm:px-8 sm:py-12">
        ...
        {testimonials.map((t, i) => (
          <Reveal
            ...
            className={`max-w-[30rem] ${
              i === 0
                ? "mr-auto"
                : "mt-16 ml-auto text-left md:mt-24 md:max-w-[32rem] lg:-mt-4 lg:mr-8"
            } ${i === 0 ? "lg:ml-8" : ""}`}
          >
            <figure>
              <blockquote>
