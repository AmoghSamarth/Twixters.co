        ...
        <div className="relative my-auto py-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
            ...
            {/* ────────────────────────────────────────────────
                ...
                Composition on Desktop: [Image Stack (Toward Center)]  [Text & List (Outer Right)]
                ──────────────────────────────────────────────── */}
            <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-x-8 xl:gap-x-12 gap-y-8 lg:items-center">
              ...
              {/* Title + Service List Column (Outer Right) */}
              <div className="order-1 lg:order-2 select-none flex flex-col max-w-[340px] lg:ml-auto">
                {/* Badge */}
                <div className="flex items-center gap-3 mb-2.5">
                  <span className="text-[12px] font-mono tracking-widest text-neutral-400 uppercase">
                    02
