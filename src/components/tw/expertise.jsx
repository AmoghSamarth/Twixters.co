...
export function Expertise() {
  // Default active items matching reference image: Brand Assets (idx 6) and Hoardings (idx 2)
  const [activeLeft, setActiveLeft] = useState(6);
  const [activeRight, setActiveRight] = useState(2);

  // Smooth interaction handlers
  ...
  // Helper to calculate 3D deck transform for Left (Branding) cards with circular wrapping
  const getLeftDeckStyle = (index) => {
    ...
    // If card is further than 2 positions away, hide it
    if (absDiff > 2) {
      return {
        transform: `rotateY(${diff > 0 ? -16 : 16}deg) translate3d(${diff > 0 ? 120 : -120}px, 0, -80px) scale(0.7)`,
        opacity: 0,
        pointerEvents: "none",
        zIndex: 0,
    ...
    if (diff === 0) {
      ...
      // Peeking behind on the left (Card 5 Brand Identity System)
      translateX = -68;
      translateZ = -18;
      rotateY = 12;
      rotateZ = -1.5;
  ...
  // Helper to calculate 3D deck transform for Right (Advertising) cards with circular wrapping
  const getRightDeckStyle = (index) => {
    ...
    if (absDiff > 2) {
      return {
        transform: `rotateY(${diff > 0 ? -18 : 14}deg) translate3d(${diff > 0 ? 120 : -120}px, 0, -80px) scale(0.7)`,
        opacity: 0,
        pointerEvents: "none",
        zIndex: 0,
        transition: "transform 0.5s cubic-bezier(0.2, 0.9, 0.3, 1), opacity 0.35s ease",
    ...
    if (diff === 0) {
      // Front active Billboard card (Card 2 Ideas Move People.)
      translateX = 0;
      translateZ = 48;
      rotateY = -6;
      rotateZ = 0.5;
      ...
      // Peeking behind on the left (Card 1 dark card)
      translateX = -74;
      translateZ = -20;
      rotateY = 10;
      rotateZ = -1.5;
      ...
      // Peeking behind on the right (Card 3 Street photography)
      translateX = 72;
      translateZ = -22;
      rotateY = -14;
      rotateZ = 1.8;
      ...
      // Further behind on the right (Card 4)
      translateX = 120;
      translateZ = -48;
      rotateY = -20;
      rotateZ = 3.2;
  ...
  return (
    <section
      ...
      className="relative w-full min-h-screen flex flex-col justify-between overflow-hidden px-5 sm:px-8 lg:px-12 xl:px-16 2xl:px-20 pt-14 sm:pt-16 lg:pt-12 pb-7 lg:pb-8 select-text bg-[#f2f2f0]"
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 xl:gap-18 items-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-x-6 xl:gap-x-10 gap-y-6 lg:items-center">
              ...
              <div className="select-none flex flex-col">
                ...
                {/* Services directly on background */}
                  ...
                  {BRANDING_SERVICES.map((item, i) => {
                    ...
                    return (
                      <div
                        ...
                        className="group flex items-center gap-2.5 cursor-pointer py-0.5 transition-all duration-200 ease-out"
                        style={{
                      ...
                      >
                        ...
                        />
                        <span
                          className="tracking-[-0.018em] transition-colors duration-200 whitespace-nowrap"
                          style={{
              ...
              {/* Horizontal Image Gallery Deck */}
              <div className="flex justify-center lg:justify-end py-2 lg:py-0 overflow-visible">
                <div
                  className="relative w-full max-w-[290px] sm:max-w-[320px] xl:max-w-[360px] h-[310px] sm:h-[335px] xl:h-[365px] flex items-center justify-center select-none will-change-transform"
                  style={{ perspective: "1400px" }}
                >
                  {/* Card 0: Brand Strategy */}
                  <div
                    style={getLeftDeckStyle(0)}
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] bg-[#161619] p-6 flex flex-col justify-between border border-white/[0.08] pointer-events-none select-none"
                  >
                  ...
                  <div
                    ...
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] bg-[#141416] p-6 flex flex-col justify-between border border-white/[0.08] pointer-events-none select-none"
                  >
                  ...
                  <div
                    ...
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] overflow-hidden border border-black/[0.06] pointer-events-none select-none"
                  >
                    <img
                  ...
                  <div
                    ...
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] bg-[#fbf9f5] border border-black/[0.06] p-5 sm:p-6 flex flex-col justify-between pointer-events-none select-none"
                  >
                    <div
                      aria-hidden="true"
                  ...
                  <div
                    ...
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] bg-[#faf9f6] p-5 flex flex-col justify-between border border-black/[0.07] pointer-events-none select-none"
                  >
                    <div className="flex justify-between items-center opacity-40">
                  ...
                  {/* Card 5: Packaging (Light Identity Card with Fold - PEEKS OUT ON LEFT IN REFERENCE) */}
                  <div
                    style={getLeftDeckStyle(5)}
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] bg-[#f7f5f0] p-5 flex flex-col justify-between border border-black/[0.06] overflow-hidden pointer-events-none select-none"
                  >
                  ...
                  {/* Card 6: Brand Assets (HERO MATTE DARK "Aa" CARD FROM REFERENCE) */}
                  <div
                    style={getLeftDeckStyle(6)}
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] bg-[#141416] p-5 sm:p-6 flex flex-col justify-between border border-white/[0.08] pointer-events-auto select-none"
                  >
                    {/* Top labels */}
              ...
              <div className="flex justify-center lg:justify-end py-2 lg:py-0 overflow-visible">
                ...
                >
                  ...
                  <div
                    ...
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] bg-[#161619] p-5 sm:p-6 flex flex-col justify-between border border-white/[0.08] pointer-events-none select-none"
                  >
                    <div className="flex justify-between items-center opacity-35">
                  ...
                  {/* Card 1: Product Launch Campaigns (Dark card peeking on left) */}
                  <div
                    style={getRightDeckStyle(1)}
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] bg-[#141416] p-5 sm:p-6 flex flex-col justify-between border border-white/10 pointer-events-none select-none"
                  >
                    <div className="flex justify-between items-center opacity-35">
                  ...
                  {/* Card 2: Hoardings (HERO BILLBOARD WITH SPOTLIGHTS & LEAF SHADOW FROM REFERENCE) */}
                  <div
                    style={getRightDeckStyle(2)}
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[6px] bg-[#161618] p-2 sm:p-2.5 flex flex-col border-[2.5px] border-[#252528] pointer-events-auto select-none"
                  >
                    ...
                    <div className="relative flex-1 rounded-[4px] bg-[#faf9f6] p-4 sm:p-5 flex flex-col justify-between overflow-hidden shadow-inner border border-black/[0.06]">
                      ...
                      {/* Bold Hoarding Typography: Ideas Move People. (Didone serif from reference) */}
                  ...
                  {/* Card 3: Posters & Flyers (Urban Street Photography Card - PEEKS ON RIGHT IN REFERENCE) */}
                  <div
                    style={getRightDeckStyle(3)}
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] overflow-hidden border border-black/[0.08] pointer-events-none select-none"
                  >
                    <img
                  ...
                  <div
                    ...
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] bg-[#151518] p-5 flex flex-col justify-between border border-white/10 pointer-events-none select-none"
                  >
                    <div className="flex justify-between items-center opacity-35">
                  ...
                  <div
                    ...
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] bg-[#fbf9f5] p-5 flex flex-col justify-between border border-black/[0.08] pointer-events-none select-none"
                  >
                    <div className="flex justify-between items-center opacity-40">
                  ...
                  <div
                    ...
                    className="absolute w-[205px] sm:w-[225px] xl:w-[250px] h-[285px] sm:h-[310px] xl:h-[340px] rounded-[16px] bg-[#0d0d0f] p-5 flex flex-col justify-between border border-white/10 pointer-events-none select-none"
                  >
                    <div className="flex justify-between items-center opacity-35">
